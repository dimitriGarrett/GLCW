...
#if GL_DESKTOP
inline void GL::beginConditionalRender(unsigned int id, QueryMode mode)
{
...
inline void GL::beginQuery(QueryTarget target, unsigned int id)
{
	glBeginQuery(static_cast<unsigned int>(target), id);
}

inline void GL::endQuery(QueryTarget target)
{
...
#if VC(4, 0)
inline void GL::beginQueryIndexed(QueryTargetIndexed target, unsigned int index, unsigned int id)
{
	glBeginQueryIndexed(static_cast<unsigned int>(target), index, id);
}

inline void GL::endQueryIndexed(QueryTargetIndexed target, unsigned int index)
{
...
#if VC(4, 5)
inline void GL::createQueries(QueryTarget target, int n, unsigned int* ids)
{
...
#if VC(4, 0)
inline void GL::getQueryIndexediv(QueryTargetIndexedGet target, unsigned int index, QueryPname pname, int* params)
{
	glGetQueryIndexediv(static_cast<unsigned int>(target), index, static_cast<unsigned int>(pname), params);
}

inline int GL::getQueryIndexediv(QueryTargetIndexedGet target, unsigned int index, QueryPname pname)
{
	int temp;
...
#if GL_DESKTOP
inline void GL::getQueryObjectiv(unsigned int id, QueryResult pname, int* params)
{
	glGetQueryObjectiv(id, static_cast<unsigned int>(pname), params);
}

inline int GL::getQueryObjectiv(unsigned int id, QueryResult pname)
{
	int temp;
...
inline void GL::getQueryObjectuiv(unsigned int id, QueryResult pname, unsigned int* params)
{
	glGetQueryObjectuiv(id, static_cast<unsigned int>(pname), params);
}

inline unsigned int GL::getQueryObjectuiv(unsigned int id, QueryResult pname)
{
	unsigned int temp;
...
inline void GL::getQueryObjecti64v(unsigned int id, QueryResult pname, signed long long* params)
{
	glGetQueryObjecti64v(id, static_cast<unsigned int>(pname), params);
}

inline signed long long GL::getQueryObjecti64v(unsigned int id, QueryResult pname)
{
...
inline void GL::getQueryObjectui64v(unsigned int id, QueryResult pname, unsigned long long* params)
{
	glGetQueryObjectui64v(id, static_cast<unsigned int>(pname), params);
}

inline unsigned long long GL::getQueryObjectui64v(unsigned int id, QueryResult pname)
{
...
inline void GL::getQueryiv(QueryTargetIndexedGet target, QueryResult pname, int* params)
{
	glGetQueryiv(static_cast<unsigned int>(target), static_cast<unsigned int>(pname), params);
}

inline int GL::getQueryiv(QueryTargetIndexedGet target, QueryResult pname)
{
	int temp;
